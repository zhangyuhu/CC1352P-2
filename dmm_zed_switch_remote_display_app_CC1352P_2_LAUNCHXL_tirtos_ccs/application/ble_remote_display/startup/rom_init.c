...
/*
  OneBleLib: List of patched function ROM addresses
  -------------------------------------------------
  Purpose:              Reduce flash size of application linked with OneLib
  Problem:              Patched functions are using flash size and linked with the romInit ROM_Flash_JT[] (jump table) even if not needed by the application
  Method:               When patch is not needed, use ROM function address not the patch function address
  List of function:     Only of patched functions, see C:\A_BLE\ble_agama_work\ble-agama\examples\rtos\CC26X2R1_LAUNCHXL\ble5stack\library\sym_gen.xml
  ROM func addresses    See C:\A_BLE\ble_agama_work\ble-agama\examples\rtos\CC26X2R1_LAUNCHXL\ble5stack\library\sym_gen.xml
  Limitations:          Only for for cc26x2_v2_pg2, function symbol missing from the map file
  Alternative:          Add ifdefs in romInit JT for each function, if not in use set spinlock
*/

//#if !( HOST_CONFIG & PERIPHERAL_CFG )
#if !( CTRL_CONFIG & ( ADV_NCONN_CFG | ADV_CONN_CFG ) )
#define llSetupNextSlaveEvent                                   0x1000aaa1      //pxxx, pxxx_coc, pxxx_del
//#define smResponderProcessLTKReq                              0x00000000      //pxxx, pxxx_coc, pxxx_del
#define llNextChanIndex                                         0x10026b54      //pxxx
#endif

//#if !( HOST_CONFIG & CENTRAL_CFG )
#if !( CTRL_CONFIG & ( SCAN_CFG | INIT_CFG ) )
#define LE_ExtCreateConn                                        0x1000c0e5      //xcxx, xcxx_coc
#define llSetupConn                                             0x10022e55      //xcxx, xcxx_coc
#define llSetupNextMasterEvent                                  0x1000f081      //xcxx, xcxx_coc, xcxx_del
#endif

//#if !( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )
#if !( CTRL_CONFIG & ( ADV_NCONN_CFG | ADV_CONN_CFG | SCAN_CFG | INIT_CFG ) )
#define LL_EXT_ModemTestTx                                      0x10006965      //pcxx_coc, pcxx_del
#define LL_EXT_ModemHopTestTx                                   0x10006a01      //pcxx_coc, pcxx_del
#define LL_PhyUpdateCompleteEventCback                          0x1001836d      //pcxx, pcxx_coc, pcxx_del
#define LL_ReadPhy                                              0x1001fc95      //pcxx, pcxx_coc, pcxx_del
#define GATT_VerifyReadPermissions                              0x1001fa49      //pcxx, pcxx_coc, pcxx_del
#define GATT_VerifyWritePermissions                             0x1001ddb9      //pcxx, pcxx_coc, pcxx_del
#define gattProcessReadReq                                      0x1002446d      //pcxx, pcxx_coc, pcxx_del
#define gattProcessReadMultiReq                                 0x1001c32d      //pcxx, pcxx_coc, pcxx_del
#define gattProcessWriteReq                                     0x100236c1      //pcxx, pcxx_coc, pcxx_del
#define gattServApp_ProcessReadByTypeReq                        0x10013aad      //pcxx, pcxx_coc, pcxx_del
#define gattServApp_ProcessReadByGrpTypeReq                     0x10010aed      //pcxx, pcxx_coc, pcxx_del
#define GATT_UpdateMTU                                          0x10010e2d      //pcxx, pcxx_coc, pcxx_del
//#define smpInitiatorProcessPairingRandom                      0x00000000      //pcxx, pcxx_coc, pcxx_del
//#define HCI_LE_SetHostChanClassificationCmd                   0x00000000      //pcxx
// Cant use it LL_ENC_DecryptMsg because it extern in ll_enc.h
//#define LL_ENC_DecryptMsg                                     0x10018f91      //pcxx
#define llConnExists                                            0x10012821      //pcxx
#endif

//#if !( HOST_CONFIG & ( CENTRAL_CFG | OBSERVER_CFG ) )
#if !( CTRL_CONFIG & ( SCAN_CFG | INIT_CFG ) )
#define LE_SetExtScanEnable                                     0x1000ec11      //xcxo, xcxo_coc, xcxo_del
#endif

//#if !( HOST_CONFIG & ( PERIPHERAL_CFG | BROADCASTER_CFG ) )
#if !( CTRL_CONFIG & ( ADV_NCONN_CFG | ADV_CONN_CFG ) )
//#define LE_SetExtAdvEnable                                    0x00000000      //pxbx, pxbx_coc, pxbx_del
//#define GapAdv_prepareLoadByHandle                            0x00000000      //pxbx, pxbx_coc, pxbx_del
#endif

#if 0 // patch for all, dont use, it just for the complete patches list
//#define HCI_ReadLocalVersionInfoCmd                           0x00000000      //all
//#define abort                                                 0x00000000      //all
//#define rfMode                                                0x00000000      //all
//#define llInitFeatureSet                                      0x00000000      //all
//#define LL_SetRandomAddress                                   0x00000000      //all
//#define LL_SetAddressResolutionEnable                         0x00000000      //all
//#define LL_SetResolvablePrivateAddressTimeout                 0x00000000      //all
#endif
...
const uint32 ROM_Flash_JT[] =
{
  ...
  (uint32)smpResponderProcessPairingReq,                     // ROM_JT_OFFSET[793]
  ...
  (uint32)smpInitiatorProcessPairingRsp,                     // ROM_JT_OFFSET[824]
...
uint8 HOOK_llProcessMasterControlPacket_hook( llConnState_t *connPtr, uint8 *pBuf )
{
#if ( CTRL_CONFIG & INIT_CFG )
